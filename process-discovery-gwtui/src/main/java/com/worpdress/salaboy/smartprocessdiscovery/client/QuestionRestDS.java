...
public class QuestionRestDS extends RestDataSource {
	...
	private QuestionRestDS() {
		...
		DataSourceTextField questionField = new DataSourceTextField("text", "Text", 300, true);
		DataSourceTextField descriptionField = new DataSourceTextField("notes", "Notes", 2000, true);
		setFields(pkField, questionField, descriptionField);
